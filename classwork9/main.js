...
for (const user of usersList) {
    ...
    userPersonalInfo.append(name, username, email);

    const addressSection = document.createElement('div');
    addressSection.innerText = 'Address:'
    ...
    geoSection.append(lat, lng);
    addressSection.append(street, suite, city, zipcode, geoSection);
    ...
    userWrapper.append(userPersonalInfo, addressSection, phone, website, company);
