...
const cutStringByWords = (str, n) => {
    return str.split(" ").splice(0, n).join(" ");
}
let stringCut = "Сила тяжести приложена к центру масс тела";
document.writeln(cutStringByWords(stringCut, 5)) // 'Сила тяжести приложена к центру'
